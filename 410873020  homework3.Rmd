...
```{r ans11}
str(badEmployers$law[c(1,2)])->violatedArticles
...
```{r ans12}
table(badEmployers$name["勞動基準法第30條第5項" "勞動基準法第36條"])->table_countsByArticle
...
```{r ans13}
str(badEmployers$law[c(F,T)])-> mostViolatedArticle
